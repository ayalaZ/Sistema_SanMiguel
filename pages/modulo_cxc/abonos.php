...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
        <br>
        <p><mark><b>Nota:</b> Para conocer sobre el funcionamiento de la ventana de abonos puede consultar en la ayuda marcada con un simbolo de interrogacion.</mark></p>
        <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <select name="codigo" id="codigo" class="form-control buscador">
                                    ...
                                    <?php
                                    session_start();
                                    if (isset($_SESSION['codigoCobro'])) {
                                        $codigo = $_SESSION['codigoCobro'];
                                    } else {
                                        $codigo = 'null';
                                    }

                                    while ($datos = $clientes->fetch_array()) {
                                        if ($codigo == $datos['cod_cliente']) {
                                    ?>
                                            <option value="<?php echo $datos['cod_cliente'] ?>" selected><?php echo $datos['cod_cliente'] ?></option>
                                        <?php
                                        } else {
                                        ?>
        ...
        <div class="modal-dialog modal-sm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ol>
                        <li>Seleccione el cobrador con el cual ingresara el abono.</li>
                        <li>Debe escoger el codigo del cliente al que va a realizar el abono.</li>
                        <li>Si es necesario cambie el servicio del cliente, si no lo es omita este paso.</li>
                        <li>Verifique la cantidad de meses que abonara, de ser necesario puede cambiar la cantidad.</li>
                        <li>Presione el boton de aplicar abono, aparecera un mensaje con los datos que ingresara por favor revisarlos antes de continuar si todo esta correcto puede aanzar.</li>
                    </ol>
                    <p><b>Nota:</b> Si necesita abonar a un cliente suspendido, primero debe de reactivarlo.</p>
                </div>
            </div>
        </div>
    </div>
