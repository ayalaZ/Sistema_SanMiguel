                    ...
                    <li class="dropdown reportes">
                        ...
                        if (!isset($_SESSION["user"])) {
                            ...
                            if ($_SESSION["rol"] == 'administracion' || $_SESSION["rol"] == 'subgerencia') {
                                ...
                                <li><a href="#" data-toggle="modal" data-target="#reportePendiente3m">Reporte de facturas pendientes por año</a>
                                </li>
...
<!-- Fin Modal reporte pendientes por año -->
<div id="reportePendiente3m" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
...
</div><!-- Fin Modal reporte pendientes por año -->
</div>
