          ...
          if ($detallado == 1){
              ...
              if ($tipoServicio == "C") {
                  ...
                  if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                      $query = "SELECT * FROM tbl_abonos WHERE tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                      $resultado = $mysqli->query($query);
                  }elseif ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] != "todas") {
                      $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                      $resultado = $mysqli->query($query);
                  }elseif ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
                      $query = "SELECT * FROM tbl_abonos WHERE cobradoPor= '".$codigoCobrador."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                      $resultado = $mysqli->query($query);
                  }else {
                      $query = "SELECT * FROM tbl_abonos WHERE cobradoPor= '".$codigoCobrador."' AND idColonia= '".$colonia."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                      $resultado = $mysqli->query($query);
                  }
              ...
              if ($codigoCobrador === "todos") {
                  ...
                  while ($cobradores = $statement1->fetch_assoc()) {//RECORRIDO DE TODOS LOS COBRADORES
                      ...
                      if($tipoServicio === "A") {
                          ...
                          //SQL para todas las zonas de cobro
                          if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                              $query = "SELECT * FROM tbl_abonos WHERE anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND cobradoPor= '".$cobradorR."' AND anticipado= '".$anticipado."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                              
                          }elseif ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] != "todas") {
                              $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND codigoCobrador= '".$cobradorR."' AND anticipado= '".$anticipado."' AND anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                          }
                      }elseif ($tipoServicio == "C") {
                          if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                              $query = "SELECT * FROM tbl_abonos WHERE anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND cobradoPor= '".$cobradorR."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                          }elseif ($_POST["lCobrador"] == "todos" && $_POST["lColonia"] != "todas") {
                              $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND cobradoPor= '".$cobradorR."' AND tipoServicio= '".$tipoServicio."' AND anticipado= '".$anticipado."' AND anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                          }
                      }elseif ($tipoServicio == "I") {
                          if ($_POST["lCobrador"] === "todos" && $_POST["lColonia"] === "todas") {
                  ...
                  while ($cobradores = $statement1->fetch_assoc()) {//RECORRIDO DE TODOS LOS COBRADORES
                      ...
                      if($tipoServicio == "A") {
                          ...
                          if ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
                              ...
                              $query = "SELECT * FROM tbl_abonos WHERE idColonia= '".$colonia."' AND cobradoPor= '".$cobradorR."' AND anticipado= '".$anticipado."' AND anulada= '".$anulada."' AND nombre != '".$recibo_anulado."' AND fechaAbonado BETWEEN '".$desde."' AND '".$hasta."' ORDER BY numeroRecibo ASC";
                              $resultado = $mysqli->query($query);
                          }
                      }elseif ($tipoServicio == "C") {
                          if ($_POST["lCobrador"] != "todos" && $_POST["lColonia"] === "todas") {
