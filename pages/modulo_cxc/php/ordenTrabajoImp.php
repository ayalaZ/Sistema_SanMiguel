	  ...
	  while($row = $resultado->fetch_assoc())
	  {
        ...
        if ($row["tipoServicio"] == "I") {
          ...
          if ($row["diaCobro"] === "0") {
            ...
            if ($row['actividadInter'] == 'Instalación') {
                $pdf->SetFont('Arial','B',12);
                $pdf->Cell(190,3,utf8_decode("REPORTE DE MATERIALES"),0,1,'C');
                $pdf->SetFont('Arial','',9);
                $pdf->Ln(5);
                $pdf->cell(15,3,"Orden: ",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'L');
                $pdf->cell(115,3,"Fecha: ",0,0,'R');
                $pdf->cell(30,3,"",'B',1,'L');
                $pdf->Ln(5);
                $pdf->cell(30,3,"Trabajo: Instalacion",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'L');
                $pdf->cell(15,3,"Revision",0,0,'R');
                $pdf->cell(30,3,"",'B',1,'L');
                $pdf->Ln(5);
                $pdf->cell(30,3,"Reconexion",0,0,'R');
                $pdf->cell(30,3,"",'B',0,'L');
                $pdf->cell(15,3,"Traslado",0,0,'R');
                $pdf->cell(30,3,"",'B',1,'L');
                $pdf->Ln(5);
                $pdf->Cell(190,3,utf8_decode("DETALLES DE MATERIALES UTILIZADOS"),0,1,'C');
                $pdf->Ln(3);
                $pdf->SetFont('Arial','B',9);
                $pdf->Cell(190,3,utf8_decode("1. Cable (Detalle en metros)"),0,1,'L');
                $pdf->SetFont('Arial','',9);
                $pdf->Ln(3);
                $pdf->cell(15,3,"Coaxial ",0,0,'L');
                $pdf->cell(30,3,"Mts",'B',0,'R');
                $pdf->cell(15,3,"Fibra ",0,0,'R');
                $pdf->cell(30,3,"Mts",'B',0,'R');
                $pdf->cell(15,3,"UTP ",0,0,'R');
                $pdf->cell(30,3,"Mts",'B',1,'R');
                $pdf->Ln(3);
                $pdf->SetFont('Arial','B',9);
                $pdf->Cell(190,3,utf8_decode("2. Conectores"),0,1,'L');
                $pdf->SetFont('Arial','',9);
                $pdf->Ln(3);
                $pdf->cell(15,3,"Coaxial ",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(20,3,"FTTH AZUL ",0,0,'R');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(25,3,"FTTH VERDE ",0,0,'R');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(10,3,"UTP ",0,0,'R');
                $pdf->cell(30,3,"",'B',1,'R');
                $pdf->Ln(3);
                $pdf->SetFont('Arial','B',9);
                $pdf->Cell(190,3,utf8_decode("2. Equipos"),0,1,'L');
                $pdf->SetFont('Arial','',9);
                $pdf->Ln(3);
                $pdf->cell(20,3,"Micronodo",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(15,3,"Codigo",0,0,'R');
                $pdf->cell(50,3,"",'B',1,'R');
                $pdf->Ln(3);
                $pdf->cell(20,3,"Caja Digital",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(15,3,"Mac",0,0,'R');
                $pdf->cell(50,3,"",'B',1,'R');
                $pdf->Ln(3);
                $pdf->cell(20,3,"Caja Digital",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'R');
                ...
                $pdf->cell(50,3,"",'B',1,'R');
                $pdf->Ln(3);
                $pdf->cell(20,3,"ONU",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(15,3,"Mac",0,0,'R');
                $pdf->cell(50,3,"",'B',1,'R');
                $pdf->Ln(3);
                $pdf->cell(20,3,"Antena",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(15,3,"Mac",0,0,'R');
                $pdf->cell(50,3,"",'B',1,'R');
                $pdf->Ln(3);
                $pdf->cell(20,3,"Router",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(15,3,"Mac",0,0,'R');
                $pdf->cell(50,3,"",'B',1,'R');
                $pdf->Ln(3);
                ...
                $pdf->Ln(3);
                $pdf->SetFont('Arial','B',9);
                $pdf->Cell(190,3,utf8_decode("4. Otros Materiales (Cantidades Unitarias)"),0,1,'L');
                $pdf->SetFont('Arial','',9);
                $pdf->Ln(3);
                $pdf->cell(15,3,"Grapas",0,0,'L');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(15,3,"Herrajes",0,0,'R');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(15,3,"Splitter",0,0,'R');
                $pdf->cell(30,3,"",'B',0,'R');
                $pdf->cell(15,3,"Cinchos",0,0,'R');
                $pdf->cell(30,3,"",'B',1,'R');
                $pdf->Ln(5);
                $pdf->SetFont('Arial','B',9);
                $pdf->Cell(190,3,utf8_decode("* El llenar este documento es obligacion de la unidad tecnica, la omision del mismo estara sujeto a sanciones administrativas."),0,1,'L');
                $pdf->SetFont('Arial','',9);
            }
          ...
          if ($row["diaCobro"] == "0") {
            ...
            $pdf->Cell(95,8,'Tipo de servicio: '.$row["tipoServicio"],0,1,'R');
            $pdf->Cell(200,8,'- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -',0,1,'C');
            if ($row['actividadCable'] == 'Instalación') {
                $pdf->SetFont('Arial','B',12);
                $pdf->Cell(190,3,utf8_decode("REPORTE DE MATERIALES"),0,1,'C');
                $pdf->SetFont('Arial','',9);
                $pdf->Ln(5);
